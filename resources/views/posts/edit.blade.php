        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-9">
                    <form action="{{ route('posts.update', $post->id) }}" method="POST" enctype="multipart/form-data" class="registrationForm p-4 rounded shadow">
                        @csrf
                        @method('PUT')
                        ...
                        <button type="submit" class="btn btn-primary w-100 mt-3">Edit Post</button>
                    </form>
                </div>
            </div>
        </div>
